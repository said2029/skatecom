...
export function Scribble({ color, ...props }: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <path
        className="origin-center opacity-60 transition-[stroke-dashoffset] duration-600 ease-in [stroke-dasharray:1700] [stroke-dashoffset:1700] group-hover:[stroke-dashoffset:0]"
        filter="url(#scribble)"
        stroke={color}
        strokeLinecap="round"
