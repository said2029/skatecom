...
export function ButtonLink({
  ...
  return (
    <PrismicNextLink
      className={clsx(
        "button-cutout group mx-4 inline-flex items-center bg-gradient-to-b from-25% to-75% bg-[length:100%_400%] font-bold transition-filter transition-background-position duration-300 hover:bg-bottom",
        size === "sm" && "gap-2.5 py-2 text-base",
        size === "md" && "gap-3 px-1 text-lg py-2.5",
        size === "lg" && "text-lg gap-3 px-1 py-3",
        color === "orange" &&
